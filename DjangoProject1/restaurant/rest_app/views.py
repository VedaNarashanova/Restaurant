...
#
# from rest_app.models import Restaurant, Dish
# from rest_app.forms import NameForm, RestaurantForm,EmployeeForm
#
#
# # def index(request):
# #     return render(request, "index.html")
...
#
#
# def restaurants(request): #primame request
#     restaurants= Restaurant.objects.all()
...
# def restaurant_detail(request,restaurant_id):
#     restaurant=Restaurant.objects.get(id=restaurant_id)
#     return HttpResponse(f"Restaurant details for restauant id= {restaurant_id}. Restaurat Name: {restaurant.name}")
#
# def add_restaurant(request):
#     if request.method == "POST":
#         restaurant = RestaurantForm(request.POST)
...
# def dish(request):
#     dishes=Dish.objects.all()
#     return render(request,"dish.html",{"dish":dishes})
# def dish_detail(request,dish_id):
#     dish=Dish.objects.get(id=dish_id)
#     return HttpResponse(f"Dish details for dish id= {dish_id}. Dish Name: {dish.name}")
#
#
#
# def add_employee(request):
