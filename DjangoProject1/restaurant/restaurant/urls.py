...
#
# from django.contrib.auth import views
# from rest_app.views import add_restaurant, index, restaurants, restaurant_detail,add_employee,dish,dish_detail
#
# urlpatterns = [
#     # path('login/', views.LoginView.as_view(), name='login'),
#     # path('logout/', views.LogoutView.as_view(), name='logout'),
...
#
#     path('restaurants/', restaurants, name="restaurants"),
#     path('restaurant_details/<int:restaurant_id>/', restaurant_detail, name="restaurant_details"),
#     path('add_restaurant/', add_restaurant, name="Add restaurant"),
#
#     path('dishes/', dish, name="dishes"),
#     path('dish_details/<int:dish_id>/', dish_detail, name="dish_details"),
#
#     path('add_employee/', add_employee, name="Add employee"),
#
#
